...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymTrack locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर GymTrack लोकली इस्तेमाल कर सकते हैं।',
  ...
  'to install GymTrack as a full-screen app.': 'से GymTrack को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if GymTrack is closed.': 'आराम टाइमर अलर्ट, GymTrack बंद होने पर भी।',
  ...
  'A small file a friend imports into their own GymTrack — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने GymTrack में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Reload GymTrack': 'GymTrack फिर से लोड करें',
