...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymTrack locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de GymTrack’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install GymTrack as a full-screen app.': 'ile GymTrack’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if GymTrack is closed.': 'GymTrack kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own GymTrack — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi GymTrack\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
