...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymTrack locally on this device.": 'Этот браузер не поддерживает ключи доступа — но GymTrack можно использовать локально на этом устройстве.',
  ...
  'to install GymTrack as a full-screen app.': 'чтобы установить GymTrack как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if GymTrack is closed.': 'Оповещения таймера отдыха, даже если GymTrack закрыт.',
  ...
  'A small file a friend imports into their own GymTrack — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой GymTrack — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload GymTrack': 'Перезагрузить GymTrack',
