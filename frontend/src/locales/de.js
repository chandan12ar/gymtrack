...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymTrack locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst GymTrack trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install GymTrack as a full-screen app.': 'um GymTrack als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if GymTrack is closed.': 'Pausen-Timer-Alarm, auch wenn GymTrack geschlossen ist.',
  ...
  'A small file a friend imports into their own GymTrack — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes GymTrack importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'this isn’t an GymTrack plan file': 'das ist keine GymTrack-Plandatei',
  'Shared routine': 'Geteilte Routine',
  'Unknown exercise': 'Unbekannte Übung',
  'Weekly Training Plan': 'Wochen-Trainingsplan',
  'Made with GymTrack': 'Erstellt mit GymTrack',
  ...
  'Reload GymTrack': 'GymTrack neu laden',
