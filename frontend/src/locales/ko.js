...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymTrack locally on this device.": '이 브라우저는 패스키를 지원하지 않아요 — 그래도 이 기기에서 GymTrack을 로컬로 사용할 수 있습니다.',
  ...
  'to install GymTrack as a full-screen app.': '하면 GymTrack을 전체 화면 앱으로 설치할 수 있어요.',
  ...
  'Rest-timer alerts, even if GymTrack is closed.': 'GymTrack이 닫혀 있어도 휴식 타이머 알림을 받아요.',
  ...
  'A small file a friend imports into their own GymTrack — routines only, none of your workouts or weigh-ins.': '친구가 자신의 GymTrack으로 가져올 수 있는 작은 파일 — 루틴만 포함되며 운동 기록이나 체중은 포함되지 않습니다.',
