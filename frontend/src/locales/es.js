...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymTrack locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar GymTrack localmente en este dispositivo.',
  ...
  'to install GymTrack as a full-screen app.': 'para instalar GymTrack como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if GymTrack is closed.': 'Avisos del temporizador de descanso, incluso con GymTrack cerrado.',
  ...
  'A small file a friend imports into their own GymTrack — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio GymTrack: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload GymTrack': 'Recargar GymTrack',
