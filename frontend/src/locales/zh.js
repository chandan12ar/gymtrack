...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymTrack locally on this device.": '此浏览器不支持通行密钥——你仍可在本设备上本地使用 GymTrack。',
  ...
  'to install GymTrack as a full-screen app.': '即可将 GymTrack 安装为全屏应用。',
  ...
  'Rest-timer alerts, even if GymTrack is closed.': '休息计时提醒，即使 GymTrack 已关闭。',
  ...
  'A small file a friend imports into their own GymTrack — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 GymTrack——只有训练日，不包含你的训练记录或体重。',
